        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-md-12 col-lg-12 pt-3">
                    <div class="video-promo-content mb-md-4 mb-lg-0">
                        <h2>KYC Checks</h2>
                        <p>Performing Know Your Customer (KYC) checks is a very essential and critical element of client onboarding process especially for financial services sector. In addition to having KYC checks as a compliance issue, it has a become an integral part of a running business. With increasing regulations and digitization of KYC processes, Oysterchecks provides a highly digitized platform which aims at improving the process while facilitating scalability and cost efficiency to an organization. As part of the KYC process we offer in-depth regulatory checks such as adverse media/negative news screening, Political Exposed Person (PEP) checks and sanctions checks. These sanctions checks ensure compliance to regulatory requirements in line with UK, USA and EU jurisdiction by adhering to United Nations (UN), European Union (EU) and HM Treasury (HMT) sanction lists.</p> </div>
                </div>
            </div>
        </div>
    </section>
