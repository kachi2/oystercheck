                            ...
                            <div class="nk-block nk-block-middle nk-auth-body">
                                ...
                                <div class="nk-block-head">
                                    <div class="nk-block-head-content">
                                        <h2 class="nk-block-title">Thank You For Signing Up!</h2>
                                        <div class="nk-block-des">
                                            <p class="">A confirmation email containing your login credentials has been sent to the work email address provided.</p>
                                            <div class="mt-4 w-50">
                                                <a href="{{route('login')}}" class="btn btn-lg btn-primary">SIGN IN <i class="icon ni ni-arrow-right-circle ml-3"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div><!-- .nk-block-head -->
