                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 align-self-center">
                            <div class="card-body d-flex justify-content-lg-end justify-content-center">
                                <a type="button" class="btn btn-primary btn-lg" href="{{route('businessCheck', $slug->slug)}}">      <img src="{{asset('assets/images/favicon.png')}}" width="30px" > Verify {{strtoupper($slug->slug)}}</a>
