                        ...
                        <div class="table-responsive">
                            ...
                            @foreach ($logs as $trans)
                                <tr>
                                    ...
                                    <td class="px-0 py-0"><a class="table-link" href="{{route('showIdentityReport', ['slug'=>$slug->slug, 'verificationId'=>$trans->id])}}"><div class="px-2 py-3">{{$trans->status == 'found' ? $trans->bank_details->accountName : 'N/A'}}</div></a></td>
