                     ...
                     <div class="row">
                         ...
                         <div class="col-md-6 align-self-center">
                             <div class="card-body d-flex justify-content-lg-end justify-content-center">
                                 <a type="button" class="btn btn-primary" href="{{route('showIdentityVerificationForm', $slug->slug)}}">Verify Candidate</a>
                            ...
                            @foreach ($logs as $trans)
                                <tr>
                                    ...
                                    <td class="px-0 py-0"><a class="table-link" href="{{route('showIdentityReport', ['slug'=>$slug->slug, 'verificationId'=>$trans->id])}}">
                                        <div class="px-2 py-3">
                                            @if($trans->status == 'completed' && $trans->all_validation_passed == true)
                                                <span class="badge badge-soft-success">Completed</span> 
                                            @else
                                                <span class="badge badge-soft-warning">Completed & not match</span>
                                            @endif  
                                        </div></a>
                                    </td>
