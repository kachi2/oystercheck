            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body" id="pdfContent">
                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                @if($ndl_verification->status == 'pending')
                                ...
                                @elseif($ndl_verification->status == 'found')
                                @if($ndl_verification->validations != null && $ndl_verification->all_validation_passed == false)
                                <div class="alert custom-alert alert-warning icon-custom-alert shadow-sm fade show d-flex justify-content-between" role="alert">
                                    <div class="media">
                                        ...
                                        <div class="media-body align-self-center">
                                            <h5 class="mb-1 fw-bold mt-0 text-warning">Drivers License Found but Not Validated</h5>
                                ...
                                <div class="alert custom-alert alert-success icon-custom-alert shadow-sm fade show d-flex justify-content-between" role="alert">
                                    <div class="media">
                                        ...
                                        <div class="media-body align-self-center">
                                            <h5 class="mb-1 fw-bold mt-0 text-success">Drivers License Found and Validated</h5>
                                ...
                                <div class="alert custom-alert alert-danger icon-custom-alert shadow-sm fade show d-flex justify-content-between" role="alert">
                                    <div class="media">
                                        ...
                                        <div class="media-body align-self-center">
                                            <h5 class="mb-1 fw-bold mt-0 text-danger">Drivers License Not Found</h5>
                                            <span>You provided an invalid drivers license number</span>
                                        </div>
                                    </div>
                                </div>
                                @endif
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="my-4 d-flex justify-content-between align-items-center">
                                    <h4 class="fw-semibold text-dark font-16">Identity (Drivers License) Report - {{$ndl_verification->ref}}</h4>
                                    <div>
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-12 col-md-4 d-flex py-4 px-4 border-bottom">
                                        ...
                                        <div class="font-14 col-8 text-break">{{$ndl_verification->ref}}</div>
                                    </div>
                                    <div class="col-12 col-md-4 d-flex py-4 px-4 border-bottom">
                                        <div class="m-0 font-14 me-3 text-muted col-4">Initiated At:</div>
                                        <div class="font-14 col-8">{{date('jS F Y, h:iA', strtotime($ndl_verification->requested_at))}}</div>
                                    </div>
                                    <div class="col-12 col-md-4 d-flex py-4 px-4 border-bottom">
                        ...
                        <div class="row mt-3">
                            ...
                            @if($ndl_verification->status == 'found')
                            <div class="col-12">
                                <div class="row  border-bottom">
                                    <div class="col-6 col-lg-4 align-self-center py-4 px-4 mb-3 mb-lg-0">
                                        <div class="dastone-profile-main">
                                            <div class="dastone-profile-main-pic rounded-circle {{$ndl_verification->selfie_validation ==true ? 'border border-5': ''}} {{$ndl_verification->selfie_validation ==true && $ndl_verification->validations->selfie->selfieVerification->match==true? 'border-success' : 'border-warning'}}">
                                            <img src="{{$ndl_verification->image}}" style="display:block;position:absolute;height:100%;top:50%;left:50%;-ms-transform: translateY(-50%);-webkit-transform: translateY(-50%);transform: translateY(-50%) translateX(-50%);"/>    
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6 d-flex py-4 px-4 border-bottom">
                                        ...
                                        <div class="font-14 col-8">
                                            {{$ndl_verification->first_name}}
                                            @if(isset($ndl_verification->validations->data->firstName))
                                            @if($ndl_verification->validations->data->firstName->validated == true)
                                            <span class="ms-2 badge bg-success">Validated</span>
                                            @else
                                            <span class="ms-2 font-12 text-info" style="text-decoration: line-through;">{{$ndl_verification->validations->data->firstName->value}}</span>
                                    ...
                                    <div class="col-12 col-md-6 d-flex py-4 px-4 border-bottom">
                                        ...
                                        <div class="font-14 col-8">
                                            {{$ndl_verification->last_name}}
                                            @if(isset($ndl_verification->validations->data->lastName))
                                            @if($ndl_verification->validations->data->lastName->validated == true)
                                            <span class="ms-2 badge bg-success">Validated</span>
                                            @else
                                            <span class="ms-2 font-12 text-info" style="text-decoration: line-through;">{{$ndl_verification->validations->data->lastName->value}}</span>
                                            <span class="ms-3 badge bg-danger">Not a match</span>
                                            @endif
                                            @endif
                                        </div>
                                    </div>
                                    @if($ndl_verification->middle_name != null)
                                    <div class="col-12 col-md-6 d-flex py-4 px-4 border-bottom">
                                        <div class="m-0 font-14 me-3 text-muted col-4">Middle Name:</div>
                                        <div class="font-14 col-8">{{$ndl_verification->middle_name}}</div>
                                    </div>
                                    @endif
                                    @if($ndl_verification->phone != null)
                                    <div class="col-12 col-md-6 d-flex py-4 px-4 border-bottom">
                                        <div class="m-0 font-14 me-3 text-muted col-4">Phone Number:</div>
                                        <div class="font-14 col-8">{{$ndl_verification->phone}}</div>
                                    </div>
                                    @endif
                                    @if($ndl_verification->email != null)
                                    <div class="col-12 col-md-6 d-flex py-4 px-4 border-bottom">
                                        <div class="m-0 font-14 me-3 text-muted col-4">Email Address:</div>
                                        <div class="font-14 col-8">{{$ndl_verification->email}}</div>
                                    </div>
                                    @endif
                                    <div class="col-12 col-md-6 d-flex py-4 px-4 border-bottom">
                                        <div class="m-0 font-14 me-3 text-muted col-4">Date of Birth:</div>
                                        <div class="font-14 col-8">
                                            {{date('jS F Y', strtotime($ndl_verification->dob))}}
                                            @if(isset($ndl_verification->validations->data->dateOfBirth))
                                            @if($ndl_verification->validations->data->dateOfBirth->validated == true)
                                            <span class="ms-2 badge bg-success">Validated</span>
                                            @else
                                            <span class="ms-2 font-12 text-info" style="text-decoration: line-through;">{{$ndl_verification->validations->data->dateOfBirth->value}}</span>
                                            <span class="ms-3 badge bg-danger">Not a match</span>
                                            @endif
                                            @endif
                                        </div>
                                    </div>
                                    @if($ndl_verification->gender != null)
                                    <div class="col-12 col-md-6 d-flex py-4 px-4 border-bottom">
                                        <div class="m-0 font-14 me-3 text-muted col-4">Gender:</div>
                                        <div class="font-14 col-8">{{$ndl_verification->gender}}</div>
                                    </div>
                                    @endif
                                    <div class="col-12 col-md-6 d-flex py-4 px-4 border-bottom">
                                        <div class="m-0 font-14 me-3 text-muted col-4">License Number:</div>
                                        <div class="font-14 col-8">{{$ndl_verification->pin}}</div>
                                    </div>
                                    @if($ndl_verification->expired_date != null)
                                    <div class="col-12 col-md-6 d-flex py-4 px-4 border-bottom">
                                        <div class="m-0 font-14 me-3 text-muted col-4">Expiry Date:</div>
                                        <div class="font-14 col-8">{{$ndl_verification->expired_date}}</div>
                                    </div>
                                    @endif
                                    @if($ndl_verification->issued_date != null)
                                    <div class="col-12 col-md-6 d-flex py-4 px-4 border-bottom">
                                        <div class="m-0 font-14 me-3 text-muted col-4">issued Date:</div>
                                        <div class="font-14 col-8">{{$ndl_verification->issued_date}}</div>
                                    </div>
                                    @endif
                                    @if($ndl_verification->state_of_issuance != null)
                                    <div class="col-12 col-md-6 d-flex py-4 px-4 border-bottom">
                                        <div class="m-0 font-14 me-3 text-muted col-4">State of Issuance:</div>
                                        <div class="font-14 col-8">{{$ndl_verification->state_of_issuance}}</div>
                                    </div>
                                    @endif
                                    <div class="col-12 col-md-6 d-flex py-4 px-4 border-bottom">
                                        <div class="m-0 font-14 me-3 text-muted col-4">Country:</div>
                                        <div class="font-14 col-8">{{$ndl_verification->country}}</div>
                                    </div>
                                
                                </div>
                            </div>
                            @if($ndl_verification->selfie_validation == true)
                            ...
                            <div class="row">
                                <div class="col-4 col-sm-4 col-lg-4 align-self-center py-4 mb-3 mb-lg-0 text-center">
                                    <div class="dastone-profile-main justify-content-center">
                                        <div class="dastone-profile-main-pic rounded-circle border border-5 {{$ndl_verification->validations->selfie->selfieVerification->match==true? 'border-success' : 'border-warning'}}">
                                        <img src="{{$ndl_verification->validations->selfie->selfieVerification->image}}" style="display:block;position:absolute;height:100%;top:50%;left:50%;-ms-transform: translateY(-50%);-webkit-transform: translateY(-50%);transform: translateY(-50%) translateX(-50%);"/>    
                                ...
                                <div class="col-8 col-sm-8">
                                    <div class="col-12 d-flex py-4 px-4 border-bottom">
                                        ...
                                        <div class="font-14 col-8">{{$ndl_verification->validations->selfie->selfieVerification->confidenceLevel}}%</div>
                                    </div>
                                    <div class="col-12 d-flex py-4 px-4 border-bottom">
                                        <div class="m-0 font-14 me-3 text-muted col-4">Threshold Level:</div>
                                        <div class="font-14 col-8">{{$ndl_verification->validations->selfie->selfieVerification->threshold}}%</div>
                                    </div>
                                    <div class="col-12 d-flex py-4 px-4 border-bottom">
                                        <div class="m-0 font-14 me-3 text-muted col-4">Match:</div>
                                        <div class="font-14 col-8">{{$ndl_verification->validations->selfie->selfieVerification->match == true ? 'Yes' : 'No'}}</div>
                                    </div>
                                </div>
                            </div>
                            @endif

                            @if($ndl_verification->data_validation == true || $ndl_verification->selfie_validation == true)
                            @if($ndl_verification->all_validation_passed == false)
                            ...
                            <div class="col-auto mt-3">
                                <div class="alert alert-warning border-0 font-15" role="alert">
                                    {{$ndl_verification->validations->validationMessages}}
                                </div>
                            </div>
                            @endif
                            @endif
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-lg-12 text-center align-self-center">
                                                    <img src="{{$ndl_verification->image}}" alt="Image from Source" class="img-fluid" />
                                                </div>
                                            </div>
                                            <!--end row-->
                                        </div>
                                ...
                                <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
                                    <div class="modal-content" style="background:none">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-lg-12 text-center align-self-center">
                                                    <img src="{{$ndl_verification->validations->selfie->selfieVerification->image}}" alt="Image from Source" class="img-fluid" />
                                                </div>
                                            </div>
                                            <!--end row-->
                                        </div>
                            ...
                            @endif
                            @elseif($ndl_verification->status == 'not_found')
                                <div class="row mt-5">
                                    <div class="col-12 col-sm-9 col-md-6 ms-auto me-auto text-center align-items-center">
                                        
                                        <h5 class="card-title mb-5 text-muted">You Searched for "{{$ndl_verification->pin}}"</h5>
                                        ...
                                        <a href="{{route('showIdentityVerificationForm', $ndl_verification->type)}}" class="btn btn-primary btn-sm mt-4 mb-3">Make another request</a>
                                    </div>
                                </div>
                            @else
